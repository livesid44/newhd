        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Visit>().HasData(
                new Visit
                {
                    ...
                    TcvMnUsd = 1.5m,
                    NameAndNoOfAttendees = "Mark Williams, Sarah Davis (5 attendees)",
                    VisitDuration = "1 Day",
                    AdditionalInformation = "Important strategic meeting - Demonstrate cloud capabilities and cost savings",
                    CreatedDate = DateTime.Now,
                ...
                new Visit
                {
                    ...
                    TcvMnUsd = 3.2m,
                    NameAndNoOfAttendees = "Peter Brown, Lisa Anderson (8 attendees)",
                    VisitDuration = "4 Hours",
                    AdditionalInformation = "Follow-up demo session - Showcase platform scalability and security features",
                    CreatedDate = DateTime.Now,
                    CreatedBy = "admin@visitmanagement.com"
                }
            );
